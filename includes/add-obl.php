...
<form method="post">
    ...
    <br><br>
    <p><i class="icon-star-half-alt" aria-hidden="true"></i> Рейтинг: <input type="text" name="rating" value="10" /></p>

    <input type="hidden" name="category" value="excursion-obl">
